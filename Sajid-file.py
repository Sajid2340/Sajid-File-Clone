...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mSajid Hossain 
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801941670534
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mSajid Vlog200
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("https://youtube.com/channel/UCp3h7RSgvIJetdaM8CV8fGg")
		exit()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [SAJID-CP] %s|%s        '%(b,idf,pw))
